...
INTERACTIONSYSTEM_API UEnum* Z_Construct_UEnum_InteractionSystem_EStartInteractType();
...
// Begin Enum EStartInteractType
static FEnumRegistrationInfo Z_Registration_Info_UEnum_EStartInteractType;
static UEnum* EStartInteractType_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_EStartInteractType.OuterSingleton)
	{
		Z_Registration_Info_UEnum_EStartInteractType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_InteractionSystem_EStartInteractType, (UObject*)Z_Construct_UPackage__Script_InteractionSystem(), TEXT("EStartInteractType"));
	}
	return Z_Registration_Info_UEnum_EStartInteractType.OuterSingleton;
}
template<> INTERACTIONSYSTEM_API UEnum* StaticEnum<EStartInteractType>()
{
	return EStartInteractType_StaticEnum();
}
struct Z_Construct_UEnum_InteractionSystem_EStartInteractType_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BeginObserving.Name", "EStartInteractType::BeginObserving" },
		{ "BlueprintType", "true" },
		{ "GetFocus.Name", "EStartInteractType::GetFocus" },
		{ "KeyInput.Name", "EStartInteractType::KeyInput" },
		{ "ModuleRelativePath", "Public/InteractionTargetComponent.h" },
	};
#endif // WITH_METADATA
	static constexpr UECodeGen_Private::FEnumeratorParam Enumerators[] = {
		{ "EStartInteractType::KeyInput", (int64)EStartInteractType::KeyInput },
		{ "EStartInteractType::BeginObserving", (int64)EStartInteractType::BeginObserving },
		{ "EStartInteractType::GetFocus", (int64)EStartInteractType::GetFocus },
	};
	static const UECodeGen_Private::FEnumParams EnumParams;
};
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_InteractionSystem_EStartInteractType_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_InteractionSystem,
	nullptr,
	"EStartInteractType",
	"EStartInteractType",
	Z_Construct_UEnum_InteractionSystem_EStartInteractType_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_InteractionSystem_EStartInteractType_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_InteractionSystem_EStartInteractType_Statics::Enum_MetaDataParams), Z_Construct_UEnum_InteractionSystem_EStartInteractType_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_InteractionSystem_EStartInteractType()
{
	if (!Z_Registration_Info_UEnum_EStartInteractType.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EStartInteractType.InnerSingleton, Z_Construct_UEnum_InteractionSystem_EStartInteractType_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_EStartInteractType.InnerSingleton;
}
// End Enum EStartInteractType
...
static const FName NAME_UInteractionTargetComponent_WantFocus = FName(TEXT("WantFocus"));
float UInteractionTargetComponent::WantFocus(const UInteractorComponent* InteractorComponent)
{
	UFunction* Func = FindFunctionChecked(NAME_UInteractionTargetComponent_WantFocus);
	...
	{
		return WantFocus_Implementation(InteractorComponent);
	}
}
...
struct Z_Construct_UClass_UInteractionTargetComponent_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_StartInteractType_MetaData[] = {
		{ "Category", "InteractionTargetComponent" },
		{ "ExposeOnSpawn", "TRUE" },
		{ "ModuleRelativePath", "Public/InteractionTargetComponent.h" },
	};
