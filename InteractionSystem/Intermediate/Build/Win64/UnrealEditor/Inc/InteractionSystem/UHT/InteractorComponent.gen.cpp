...
static const FName NAME_UInteractorComponent_AcceptNewInteractable = FName(TEXT("AcceptNewInteractable"));
bool UInteractorComponent::AcceptNewInteractable(UInteractionTargetComponent* Target)
{
	UFunction* Func = FindFunctionChecked(NAME_UInteractorComponent_AcceptNewInteractable);
	...
	{
		return AcceptNewInteractable_Implementation(Target);
	}
}
