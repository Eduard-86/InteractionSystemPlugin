...
static const FName NAME_UModuleBaseTarget_ExecuteActionEvent = FName(TEXT("ExecuteActionEvent"));
...
{
	UFunction* Func = FindFunctionChecked(NAME_UModuleBaseTarget_ExecuteActionEvent);
	...
	{
		ExecuteActionEvent_Implementation(SettingsBlackboard, OwnerInteraction);
	}
}
