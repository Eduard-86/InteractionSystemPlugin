...
static const FName NAME_UModuleFocusTarget_GetFocus = FName(TEXT("GetFocus"));
float UModuleFocusTarget::GetFocus(const UInteractorComponent* TargetComponent)
{
	UFunction* Func = FindFunctionChecked(NAME_UModuleFocusTarget_GetFocus);
	...
	{
		return GetFocus_Implementation(TargetComponent);
	}
}
