...
static FName NAME_UModuleDisplayTarget_DisplayTick = FName(TEXT("DisplayTick"));
void UModuleDisplayTarget::DisplayTick(float DeltaTime)
{
	ModuleDisplayTarget_eventDisplayTick_Parms Parms;
	Parms.DeltaTime=DeltaTime;
	ProcessEvent(FindFunctionChecked(NAME_UModuleDisplayTarget_DisplayTick),&Parms);
}
...
static FName NAME_UModuleDisplayTarget_FocusGet = FName(TEXT("FocusGet"));
void UModuleDisplayTarget::FocusGet(UInteractionTargetCollisionModular* OwnerTarget, const UInteractorComponent* InteractorComponent)
{
	...
	ProcessEvent(FindFunctionChecked(NAME_UModuleDisplayTarget_FocusGet),&Parms);
}
...
static FName NAME_UModuleDisplayTarget_FocusLose = FName(TEXT("FocusLose"));
void UModuleDisplayTarget::FocusLose(UInteractionTargetCollisionModular* OwnerTarget, const UInteractorComponent* InteractorComponent)
{
	...
	Parms.OwnerTarget=OwnerTarget;
	Parms.InteractorComponent=InteractorComponent;
	ProcessEvent(FindFunctionChecked(NAME_UModuleDisplayTarget_FocusLose),&Parms);
}
...
static FName NAME_UModuleDisplayTarget_OwnInteractorBeginOvelrap = FName(TEXT("OwnInteractorBeginOvelrap"));
void UModuleDisplayTarget::OwnInteractorBeginOvelrap(UInteractionTargetCollisionModular* OwnerTarget, const UInteractorComponent* InteractorComponent)
{
	...
	Parms.OwnerTarget=OwnerTarget;
	Parms.InteractorComponent=InteractorComponent;
	ProcessEvent(FindFunctionChecked(NAME_UModuleDisplayTarget_OwnInteractorBeginOvelrap),&Parms);
}
...
static FName NAME_UModuleDisplayTarget_OwnInteractorEndOvelrap = FName(TEXT("OwnInteractorEndOvelrap"));
void UModuleDisplayTarget::OwnInteractorEndOvelrap(UInteractionTargetCollisionModular* OwnerTarget, const UInteractorComponent* InteractorComponent)
{
	...
	Parms.OwnerTarget=OwnerTarget;
	Parms.InteractorComponent=InteractorComponent;
	ProcessEvent(FindFunctionChecked(NAME_UModuleDisplayTarget_OwnInteractorEndOvelrap),&Parms);
}
